...
$c = new  Connection();
$query = "SELECT * FROM news where news_categores='Breaking'order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_categores='Breaking' order by id desc limit 0,3";
