...
$c = new  Connection();
$query = "SELECT * FROM news where news_categores='Standard' order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_categores='Standard' order by id desc limit 0,3";
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-right no-padding">
							<ul>
								<li><a href="tel:+440 012 3654 896"><span class="lnr lnr-phone-handset"></span><span>+91 1236547890</span></a></li>
					...
					<div class="row">
						<div class="col-lg-8 post-list">
							...
							<div class="latest-post-wrap">
								<h4 class="cat-title">Standard News</h4>
								...
								<div class="single-sidebar-widget editors-pick-widget">
									...
									<div class="editors-pick-post">
										<div class="feature-img-wrap relative">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="img/61.jpg" alt="">
											</div>
											<ul class="tags">
												<li><a href="https://indianexpress.com/article/sports/ipl/australian-players-could-fly-to-uk-with-england-and-india-players-on-chartered-flight-hints-maxwell-7296649/">IPl</a></li>
											</ul>
										</div>
										<div class="details">
											<a href="https://indianexpress.com/article/sports/ipl/australian-players-could-fly-to-uk-with-england-and-india-players-on-chartered-flight-hints-maxwell-7296649/">
												<h4 class="mt-20">Australian players could fly to UK with
												England and India players on chartered flight, hints Maxwell</h4>
											</a>
											<ul class="meta">
											...
											<p class="excert">
												India and New Zealand are set to fight it out in the World Test Championship final from
												June 18 and will fly to England for that after the IPL ends. 
												England players in the ongoing league are expected to accompany them in the same flight.
											</p>
