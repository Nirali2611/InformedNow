...
$c = new  Connection();
$query = "SELECT * FROM news where news_type='National' order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_type='National' order by id desc limit 0,3";
				...
				<div class="container">
					<div class="row justify-content-between items-center">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 right no-padding">
							<img class="img-fluid" src="img/advs16.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-4">
							<div class="sidebars-area">
								<div class="single-sidebar-widget editors-pick-widget">
									...
									<div class="editors-pick-post">
										<div class="feature-img-wrap relative">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="img/64.jpg" alt="">
											</div>
											<ul class="tags">
												<li><a href="https://www.hindustantimes.com/">National</a></li>
											</ul>
										</div>
										<div class="details">
											<a href="https://www.hindustantimes.com/">
												<h4 class="mt-20">Global medical supply chains on G7 ministerial in UK on Monday</h4>
											</a>
											
											<p class="excert">
												The main agenda will be to establish global medical supply chains to fight the coronavirus pandemic, 
												which has returned in waves all over the world.
											</p>
											<ul class="meta">
								...
								<div class="single-sidebar-widget ads-widget">
									<img class="img-fluid" src="img/advs17.jpg" alt="">
								</div>
