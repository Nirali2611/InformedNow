...
$c = new  Connection();
$query = "SELECT * FROM news where news_type='Economic' order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_type='Economic' order by id desc limit 0,3";
				...
				<div class="container">
					<div class="row justify-content-between items-center">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 right no-padding">
							<img class="img-fluid" src="img/advs8.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-4">
							<div class="sidebars-area">
								...
								<div class="single-sidebar-widget ads-widget">
									<img class="img-fluid" src="img/advs11.jpg" alt="">
								</div>
