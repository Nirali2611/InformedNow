...
$c = new  Connection();
$query = "SELECT * FROM news where news_type='Local' order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_type='Local' order by id desc limit 0,3";
						...
						<div class="col-lg-4">
							<div class="sidebars-area">
								...
								<div class="single-sidebar-widget ads-widget">
									<img class="img-fluid" src="img/advs20.jpg" alt="">
								</div>
