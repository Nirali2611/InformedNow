...
$c = new  Connection();
$query = "SELECT * FROM news where news_type='Helth' order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_type='Helth' order by id desc limit 0,3";
				...
				<div class="container">
					<div class="row justify-content-between items-center">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 right no-padding">
							<img class="img-fluid" src="img/advs19.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
							...
							<div class="latest-post-wrap">
								...
								echo '<div class="single-latest-post row align-items-center">
									...
									<div class="col-lg-7 post-right">
										...
										<ul class="meta">
											<li><a href="#"><span class="lnr lnr-calendar-full">'.$data[8].'</span></a></li>
