...
$c = new  Connection();
$query = "SELECT * FROM news where news_categores='Latest' order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_categores='latest' order by id desc limit 0,3";
				...
				<div class="container">
					<div class="row justify-content-between items-center">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 right no-padding">
							<img class="img-fluid" src="img/advs4.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
								...
								<div class="single-sidebar-widget editors-pick-widget">
									...
									<div class="editors-pick-post">
										<div class="feature-img-wrap relative">
											<div class="feature-img relative">
												<div class="overlay overlay-bg"></div>
												<img class="img-fluid" src="img/62.jpg" alt="">
											</div>
											<ul class="tags">
										...
										<div class="details">
											<a href="">
												<h4 class="mt-20">Israel to welcome vaccinated visitors in May 2021</h4>
											</a>
											<ul class="meta">
												<li><a href="#"><span class="lnr lnr-calendar-full"></span>30 April , 2021</a></li>
											</ul>
											<p class="excert">
												It is believed the first 40 tour groups are expected to land in the country on May 23.
												Individual visitors, however, will have to wait until July 2021
											</p>
