...
$c = new  Connection();
$query = "SELECT * FROM news where news_type='Business' order by id ASC limit 4";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_type='Business' order by id desc limit 0,3";
					...
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<ul>
								...
								<li><a href="image-post.html">Latest</a></li>
								<li><a href="gallery-post.html">Breaking</a></li>
								<li><a href="video-post.html">Popular</a></li>
							</ul>
							</li>
						...
						<div class="col-lg-4">
							<div class="sidebars-area">
								...
								<div class="single-sidebar-widget ads-widget">
									<img class="img-fluid" src="img/advs22.jpg" alt="">
								</div>
