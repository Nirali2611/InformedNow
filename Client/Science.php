...
$c = new  Connection();
$query = "SELECT * FROM news where news_type='Science' order by id ASC limit 0,1";
$res = mysqli_query($c->con,$query);

$latest_query = "SELECT * FROM news where news_type='Science' order by id desc limit 0,3";
				...
				<div class="container">
					<div class="row justify-content-between items-center">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 right no-padding">
							<img class="img-fluid" src="img/advs5.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center justify-content-between">
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<ul>
								<li><a href="Standar.php">Standard</a></li>
						...
						<div class="col-lg-4">
							<div class="sidebars-area">
								...
								<div class="single-sidebar-widget ads-widget">
									<img class="img-fluid" src="img/advs23.jpg" alt="">
								</div>
